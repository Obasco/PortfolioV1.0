    ...
    <>
      <section className="bg-[#0A0A0A] text-white min-h-screen flex justify-center items-center py-0 px-8 lg:px-15 border-b  border-b-[#484848]">
        ...
        <div className="max-w-6xl w-full grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="flex flex-col space-y-6 lg:mt-20" data-aos="fade-right" data-aos-duration="1000">
            {/* Main Heading Block */}
          ...
          {/* --- Right Content: Image --- */}
          <div className="hidden lg:flex justify-center" data-aos="fade-left" data-aos-duration="1000">
